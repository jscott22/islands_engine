defmodule IslandEngine.Rules do
  ...
  @doc """
  Checks if islands can be positioned for a player
  """
  ...
  @doc """
  Checks if a player can set their islands, and if both players have set or not
  """
  ...
  @doc """
  Checks if player one can make a guess
  """
  ...
  @doc """
  Checks if player two can make a guess
  """
