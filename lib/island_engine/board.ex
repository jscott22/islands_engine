defmodule IslandEngine.Board do
  alias IslandEngine.{Island, Coordinate}

  def new(), do: %{}

  @doc """
  Attempts to position an island. Either adds it to the board or returns an overlapping island error
  """
  ...
  @doc """
  Tests to see if an island overlaps an existing one when it is placed
  """
